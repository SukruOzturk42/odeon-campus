...
var KTLayoutAside = (function() {
  ...
  var _initNav = function() {
    ...
    KTUtil.scrollInit(asideNav, {
      ...
      height: function() {
        ...
        height =
          height -
          (parseInt(KTUtil.css(asideBrand, "marginBottom")) +
            parseInt(KTUtil.css(asideBrand, "marginTop")));

        height = height - parseInt(KTUtil.css(asideFooter, "height"));
        height =
          height -
          (parseInt(KTUtil.css(asideFooter, "marginBottom")) +
            parseInt(KTUtil.css(asideFooter, "marginTop")));
  ...
  var _initWorkspace = function() {
    ...
    var asideWorkspace = KTUtil.find(
      _element,
    ...
    KTUtil.scrollInit(asideWorkspace, {
      ...
      height: function() {
        ...
        height =
          height -
          (parseInt(KTUtil.css(asideWorkspace, "marginBottom")) +
            parseInt(KTUtil.css(asideWorkspace, "marginTop")));
        height =
          height -
          (parseInt(KTUtil.css(asideSecondary, "paddingBottom")) +
            parseInt(KTUtil.css(asideSecondary, "paddingTop")));
