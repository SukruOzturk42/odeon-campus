...
import AsideCodeMenuList from "./AsideCodeMenuList";

export function AsideMenuCode({ menu, handleSetComponentProperites }) {
    ...
    return (
        <div className={`tab-pane fade ${"show active"}`}>
          <div className="aside-menu-wrapper flex-column-fluid px-3 py-5">
            ...
            >
              <AsideCodeMenuList layoutProps={layoutProps} menu={menu} />
            </div>
            {/* end::Menu Container */}
          </div>
        </div>
