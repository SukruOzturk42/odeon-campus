...
import AsideRuleMenuList from "./AsideRuleMenuList";

export function AsideMenuRule({ menu, handleSetComponentProperites }) {
    ...
    return (
        <div className={`tab-pane fade ${"show active"}`}>
          <div className="aside-menu-wrapper flex-column-fluid px-3 py-5">
            ...
            >
              <AsideRuleMenuList layoutProps={layoutProps} menu={menu} />
            </div>
            {/* end::Menu Container */}
          </div>
        </div>
