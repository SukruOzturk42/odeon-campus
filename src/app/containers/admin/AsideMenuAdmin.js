...
import AsideAdminMenuList from "./AsideAdminMenuList";

export function AsideMenuAdmin({ menu, handleSetComponentProperites }) {
    ...
    return (
        <div className={`tab-pane fade ${"show active"}`}>
          <div className="aside-menu-wrapper flex-column-fluid px-3 py-5">
            ...
            >
              <AsideAdminMenuList layoutProps={layoutProps} menu={menu} />
            </div>
            {/* end::Menu Container */}
          </div>
        </div>
